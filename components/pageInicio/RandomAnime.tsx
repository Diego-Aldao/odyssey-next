...
export default function RandomAnime() {
  ...
  return (
    <div
      onClick={handleClick}
      className="fixed bottom-20 left-0 lg:-left-28 p-2 transition-all group hover:-left-0 group opacity-80 lg:opacity-100 flex items-center justify-center gap-6 bg-secondary-black rounded-r-3xl z-[12] cursor-pointer hover:bg-tertiary-black"
    >
